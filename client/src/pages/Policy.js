  ...
  return (
    <Layout title={"Privacy Policies"} >
      <div className="row contactus " style={{margin:"0 auto"}}>
        ...
        <h2 className="bg-dark p-2 text-white text-center" style={{borderRadius:"10px"}}>PRIVACY POLICIES</h2>
          <p>rb_coding built the Ecommerce Web App app as a Commercial app. This SERVICE is provided by rb_coding and is intended for use as is.This page is used to inform visitors regarding my policies with the collection, use, and disclosure of Personal Information if anyone decided to use my Service.
            If you choose to use my Service, then you agree to the collection and use of information in relation to this policy. The Personal Information that I collect is used for providing and improving the Service. I will not use or share your information with anyone except as described in this Privacy Policy.
            The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which are accessible at Ecommerce Web App unless otherwise defined in this Privacy Policy.</p>
          <p>For a better experience, while using our Service, I may require you to provide us with certain personally identifiable information. The information that I request will be retained on your device and is not collected by me in any way.
            ...
            Link to the privacy policy of third-party service providers used by the app Facebook</p>
          <p>I want to inform you that whenever you use my Service, in a case of an error in the app I collect data and information (through third-party products) on your phone called Log Data. This Log Data may include information such as your device Internet Protocol (“IP”) address, device name, operating system version,
             the configuration of the app when utilizing my Service, the time and date of your use of the Service, and other statistics.</p>
          ...
          <p>If you have any questions or suggestions about my Privacy Policy, do not hesitate to contact me at ecommerce@info.com.
...
<!DOCTYPE html>
    ...
    <strong>Privacy Policy</strong> <p>
                  rb_coding built the Ecommerce Web App app as
                  a Commercial app. This SERVICE is provided by
                  rb_coding  and is intended for use as
                  is.
                </p> <p>
                  ...
                  Ecommerce Web App unless otherwise defined in this Privacy Policy.
                  ...
                  this page.
                </p> <p>This policy is effective as of 2023-06-09</p> <p><strong>Contact Us</strong></p> <p>
                  If you have any questions or suggestions about my
                  Privacy Policy, do not hesitate to contact me at ecommerce@info.com.
